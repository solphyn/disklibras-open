...
!(function(exports) {
    ...
    function openRoom(room) {
        $.ajax({
            ...
            url: 'https://sistema.disklibras.com.br/api.php/openroom/' + room,
            data: {
                format: 'json'
            },
            error: function(data) {
                //window.location.href = "https://disklibras.herokuapp.com/room/"+$room+"?userName=<?php echo $_SESSION['user_name'] ?>";                                
            },
            //dataType: 'jsonp',
